...
from util import construct_vocab, construct_label_vocab, CWSDataset, convert_to_index, convert_to_tensor, CrossEntropyWithMask, LoadData
...
parser.add_argument('--train_path', type=str, default='./datasets/training/pku_training.utf8',help='Training data path.')
parser.add_argument('--dev_path', type=str, default='./datasets/training/msr_training.utf8', help='Development data path.')
parser.add_argument('--eval_path', type=str, default='', help='Evaluation data path.')
parser.add_argument('--vocab_path', type=str, default='./datasets/training/pku_training_vocab.vocab', help='Vocabulary path.')
...
parser.add_argument('--hiddem_dim', type=int, default=256, help='Lstm hiddem dimension for each direction.')
...
vocab = construct_vocab(corpus_file=args.vocab_path)
